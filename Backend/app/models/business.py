...
class Cliente(Base):
    ...
    tipo_cliente = Column(Enum("CORPORATIVO", "INTERNO", "GENERAL"), default="CORPORATIVO")
...
class Proveedor(Base):
    ...
    categoria = Column(Enum("FABRICANTE", "DISTRIBUIDOR", "SERVICIO_TECNICO", "LOGISTICA"), default="DISTRIBUIDOR")
    created_at = Column(TIMESTAMP, server_default=func.now())
    deleted_at = Column(TIMESTAMP, nullable=True)
...
class Proyecto(Base):
    ...
    estado = Column(Enum("ACTIVO", "FINALIZADO", "PAUSADO"), default="ACTIVO")
