...
class Alert(Base):
    ...
    prioridad = Column(
        Enum("critica", "alta", "media", "baja", name="alerta_prioridad"),
        nullable=False,
    )
    estado = Column(
        Enum("activa", "reconocida", "resuelta", "ignorada", name="alerta_estado"),
        default="activa",
    )
...
class AlertRule(Base):
    ...
    prioridad = Column(
        Enum("critica", "alta", "media", "baja", name="regla_prioridad"), nullable=False
    )
