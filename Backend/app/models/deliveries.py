...
class ActaEntrega(Base):
    ...
    tipo_acta = Column(Enum("ENTREGA_EPP", "ENTREGA_HERRAMIENTA", "DESPACHO_PROYECTO", "DEVOLUCION", "INGRESO_DESMONTE"), nullable=False)
    estado_acta = Column(Enum("BORRADOR", "FIRMADA", "ANULADA"), server_default="BORRADOR")
