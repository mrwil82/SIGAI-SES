...
> [!NOTE]
> Este manual esta dirigido al **personal tecnico y usuarios operativos** del Sistema Integral de Gestion de Activos e Inventario (SIGAI-SES) de SES — Seguridad Electrónica.
...
**SIGAI-SES** es el Sistema Integral de Gestion de Activos e Inventario de **SES — Seguridad Electrónica**, disenado para:
