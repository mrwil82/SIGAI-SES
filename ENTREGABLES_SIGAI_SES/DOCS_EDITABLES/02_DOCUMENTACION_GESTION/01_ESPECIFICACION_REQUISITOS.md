...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Cliente-SES%20%E2%80%94%20Seguridad%20Electr%C3%B3nica-orange?style=for-the-badge&logo=flash" alt="Cliente">
...
| **Cliente final** | SES — Seguridad Electrónica — Unidad de Seguridad Electronica (SES) |
...
| ID | Nombre | Descripcion | Prioridad |
|:---:|:---|---:|:---:|
| **RF-19** | Exportacion Excel | Streaming con **XlsxWriter** (modo `constant_memory`) para **+30,000 registros**. Formato corporativo con logo SES. 5 modulos exportables. | **Media** |
...
| `Cliente` | `SES — Seguridad Electrónica` |
