...
> CORS_ALLOWED_ORIGINS=https://sigai.ses-electronica.com.co
> ADMIN_EMAIL=admin@ses-electronica.com
...
server {
    listen 80;
    server_name sigai.ses-electronica.com.co;
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/sigai.ses-electronica.com.co/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/sigai.ses-electronica.com.co/privkey.pem;
...
sudo certbot --nginx -d sigai.ses-electronica.com.co
...
# Probar endpoints
curl -k https://sigai.ses-electronica.com.co/api/v1/health
curl -k https://sigai.ses-electronica.com.co/api/v1/health/db

# Probar frontend (abrir en navegador)
# https://sigai.ses-electronica.com.co
```
