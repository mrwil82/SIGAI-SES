...
> [!IMPORTANT]
> Este manual esta dirigido al **equipo de desarrollo** y **administradores de sistemas** responsables del mantenimiento, configuracion y operacion tecnica del **Sistema Integral de Gestion de Activos e Inventario (SIGAI-SES)** para **SES — Seguridad Electrónica**
...
![Diagrama](images/01_MANUAL_TECNICO_diagram_1.png)
...
| `codigo_empleado` | `VARCHAR(20) UK` | Codigo interno SES |
...
| `activo_fijo_ses` | `VARCHAR(50)` | Placa de activo fijo |
...
![Diagrama](images/01_MANUAL_TECNICO_diagram_2.png)
...
![Diagrama](images/01_MANUAL_TECNICO_diagram_3.png)
...
![Diagrama](images/01_MANUAL_TECNICO_diagram_4.png)
